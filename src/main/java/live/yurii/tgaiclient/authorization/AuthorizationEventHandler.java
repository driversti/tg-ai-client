...
public class AuthorizationEventHandler {
  ...
  public void onAuthorizationStateChanged(UpdateAuthorizationStateEvent event) {
    ...
    switch (newState.getConstructor()) {
      ...
      case TdApi.AuthorizationStateWaitPhoneNumber.CONSTRUCTOR -> log.warn("Not implemented yet - phone number");
      ...
      case TdApi.AuthorizationStateWaitEmailAddress.CONSTRUCTOR -> log.warn("Not implemented yet - email address");
      ...
      case TdApi.AuthorizationStateWaitPassword.CONSTRUCTOR -> log.warn("Not implemented yet - password");
  ...
  static class AuthorizationRequestHandler implements Client.ResultHandler {
    ...
    public void onResult(TdApi.Object object) {
      switch (object.getConstructor()) {
        ...
        case TdApi.Error.CONSTRUCTOR -> log.error("Received an error: {}", toJson(object));
